...
/*
This component is used to show surveyor information. This will be part of row component in a List
...
export default class StatusSurveyorCell extends React.Component {
            ...
            <View style={styles.row}>
              <View style={styles.itemContainer}>
                ...
                <View style={styles.itemLineContainer}>
                  ...
                  <View style={styles.textContainer}>
                    <Text style={styles.detail}>
                      {formatDateTime(this.props.task.survey.tanggalMasukRs)}
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.itemLineContainer}>
                  <View style={styles.taskDetail}>
                    <Icon name="hourglass-half" style={styles.iconDeadline} />
                  </View>
                  <View style={styles.textContainer}>
